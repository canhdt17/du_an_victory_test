                    ...
                    <div class="form-group">
                        ...
                        <select name="seat_type_id" id="seat_type_id" class="form-control">
                            @foreach ($seatType as $id=>$seat_type_name)
                                <option @selected($seat->seat_type_id == $id) value="{{$id}}">{{$seat_type_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="showtime_date">Số ghế</label>
                        <input type="text" id="seat_number" name="seat_number" class="form-control" value="{{$seat->seat_number}}">
                    </div>

                    <div class="form-group">
                        <label for="">Id Phòng</label>
                        <input type="text" name="room_id" class="form-control" id="room_id"value="{{$seat->room_id}}">
                    </div>
                    <div class="form-group">
                        <label for="">Trạng thái</label>
                        <input type="text" name="seat_status" class="form-control" id="seat_status"value="{{$seat->seat_status}}">
                    </div>
                    <div>
